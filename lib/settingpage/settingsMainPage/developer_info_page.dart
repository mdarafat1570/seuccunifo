...
//                             Link(
//                               uri: Uri.parse(
//                                   'https://www.linkedin.com/in/md-arafat-mia/'),
//                               builder: (context, followLink) => InkWell(
//                                 onTap: followLink,
//                                 child: SizedBox(
...
//                             const SizedBox(width: 16),
//                             Link(
//                               uri: Uri.parse('https://github.com/mdarafat1570'),
//                               builder: (context, followLink) => InkWell(
//                                 onTap: followLink,
//                                 child: SizedBox(
...
//                             Link(
//                               uri: Uri.parse(
//                                   'mailto:azizulhakimfayaz@gmail.com'),
//                               builder: (context, followLink) => InkWell(
//                                 onTap: followLink,
//                                 child: SizedBox(
//                                   height: CSizes.iconMd - 2,
...
//                             Link(
//                               uri: Uri.parse(
//                                   'https://www.linkedin.com/in/azizul-hakim-629097252/'),
//                               builder: (context, followLink) => InkWell(
//                                 onTap: followLink,
//                                 child: SizedBox(
//                                     height: CSizes.iconMd,
...
//                             const SizedBox(width: 16),
//                             Link(
//                               uri: Uri.parse('https://github.com/fayaz0007'),
//                               builder: (context, followLink) => InkWell(
//                                 onTap: followLink,
//                                 child: SizedBox(
//                                   height: CSizes.iconMd - 4,
